...
% clc;clear;close all;
% imageDir = 'G:\KeyFrames\';
% files = dir(strcat(imageDir,'*.tiff'));
% exefile = 'G:\farsightExe\projproc.exe';
% defFile = 'G:\farsightExe\FarSightSegmentation\BrianDef.xml';
% 
...
% end
%！！！！！！！！！！！！！！！！
ImageOrigFile = 'frame19.tiff';
ImageGreyFile = 'frame19grey.tiff';
ImageDataFile = 'frame19._seg.txt'; %#ok<NASGU>
ImageOrig = imread(ImageOrigFile);
ImageGrey = imread(ImageGreyFile); %#ok<NASGU>
imageFarsightFile = 'frame19._seg.tif';
...
ImageDataFile = 'frame19._seg.txt';
delimiter = '\t';
startRow = 2;
